...
!  recompute nu for a different diffusivity
 ...
 write (*,*) 'diff_t 2', diff_t
 write (*,*) 'diff_m 2', diff_m
 write (*,*) 'p_full 2', p_full
 write (*,*) 'z_full 2', z_full
 write (*,*) 't 2', t
 write (*,*) 'q 2', q
 write (*,*) 'nu 2', nu
 ...
 write (*,*) 'nu_n', nu_n
 write (*,*) 'e_n1', e_n1
 write (*,*) 'mu_delt_n', mu_delt_n
 write (*,*) 'delta_tr_n', delta_tr_n
 write (*,*) 'f_tr_delt_n1', f_tr_delt_n1
