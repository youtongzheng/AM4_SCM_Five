...
!this code may not work? all these fields do not have the same data domain
        ...
        call read_data ( restart_name, 'DELP', delp(ids:ide,jcs:jce,:), domain = fv_domain)
...
! passing the array to the mpp_write routine.
        ...
        call mpp_write(iuic, delp_field, fv_domain, delp(ids:ide,jcs:jce,:))
