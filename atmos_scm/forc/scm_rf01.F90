...
real,    private               :: thl_pert = 0.   ! ZNT 06/03/2021: perturb subcloud thetal (K)
real,    private               :: qt_pert  = 0.   ! ZNT 06/03/2021: perturb subcloud qt (g/kg)
real,    private               :: thlft_pert = 0. ! ZNT 06/03/2021: perturb free-tropospheric thetal (K)
real,    private               :: qtft_pert  = 0. ! ZNT 06/03/2021: perturb free-tropospheric qt (g/kg)
...
namelist /scm_rf01_nml/ tracer_vert_advec_scheme,                   &
                        ...
                        thl_pert, qt_pert, &              ! ZNT 06/03/2021
                        thlft_pert, qtft_pert             ! ZNT 06/03/2021
...
!      qt_pert and qtft_pert added: ZNT 06/03/2021
       ...
       if ( z < 840.0 ) then
         ...
         qt = max(0.0, 1.5 + qtft_pert - 1.0e-3 * (z - 2400.))
       end if
...
!      thetal
!      thl_pert and thlft_pert added: ZNT 06/03/2021

       if ( z < 840.0 ) then
         thetal = 289.0 + thl_pert
       else if ( z < 1600.0 ) then
         thetal = 297.5 + thlft_pert + (z - 840.)**(1./3.)
       else
         thetal = 297.5 + thlft_pert + (760.)**(1./3.) +  6.0E-3 * (z - 1600.)
       end if
